    ...
    def select_topology(topology, n, l) do
        ...
        cond do
            ...
            topology == "3D" ->
                ...
                neighbor
            topology == "torus" ->
                j = :math.ceil(:math.sqrt(n)) |> round
                n = :math.pow(j,2) |> round
                ...
                cond do
                    ...
                    neighbor ++ [(l - j + 1), (l-1), (l+j), (l+ j*(j-1))] #right end to left end
                    ...
                    neighbor ++ [(l + j*(j - 1)) , (l+1), (l+j), (l+j-1)]
                  
                    #leftmost and bottommost
                    rem(l-1,j) == 0 && (l-(n-j) > 0)->
                    
                    neighbor ++ [(l + j - 1) , (l+1), (l-j), l - j*(j-1)]
                    #topmost
